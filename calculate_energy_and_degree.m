function [media desv D0 mean_Degree dev_Degree coeffs Vecinos_Evens  energia_acum D]=calculate_energy_and_degree (A_fin, label, datastore,P)
...
[D0, energia_acum, D]=calculate_average_energy(label,coeffs);
