function [energia_acum D label U_set P_set D0_acum prop_ev_acum reconst_5_perc reconst_10_perc reconst_20_perc reconst_30_perc reconst_40_perc reconst_50_perc] = MAM_error3(Q, var_ep,var_et,nu_et,label,W,c,x,size_block,ver_block,hor_block,reconst_5_perc,reconst_10_perc,reconst_20_perc,reconst_30_perc,reconst_40_perc,reconst_50_perc, restriction,flag)
...
% % % % % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % % % % [media desv D0 mean_Degree dev_Degree coeffs Vecinos_Evens  energia_acum D]=calculate_energy_and_degree (W, label, x,P_set);
% % % % % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
